...
public class MarkerBlock extends BlockContainer {
    ...
    public int getRenderType() {
        // TODO return BuildCraftCore.markerModel;
    }*/
    ...
    public TileEntity createNewTileEntity(World var1) {
        //TODO return new TileMarker();
        return null;
    }
    
    @Override
    public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer entityplayer, int par6, float par7, float par8, float par9) {
        //TODO ((TileMarker) world.getBlockTileEntity(i, j, k)).tryConnection();
        return true;
    }
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, int blockId) {
        // TODO ((TileMarker) world.getBlockTileEntity(x, y, z)).updateSignals();
