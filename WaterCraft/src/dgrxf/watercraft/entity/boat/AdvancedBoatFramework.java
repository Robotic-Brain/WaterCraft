...
public abstract class AdvancedBoatFramework extends Entity{
	...
	public AdvancedBoatFramework(World par1World) {
		super(par1World);
        this.isEmpty = true;
    ...
    public AdvancedBoatFramework(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
